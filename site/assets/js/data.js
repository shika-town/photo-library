...
window.SPL_DATA = {
  "site": {
    "name": "SHIKA PHOTO LIBRARY",
    "nameJa": "志賀町公式フォトライブラリー",
    "tagline": "能登の自然・風景・四季の魅力を、美しい写真で。",
    "copyright": "© 志賀町 All Rights Reserved."
  },
  "hero": {
    "title": [
      "志賀町フォトライブラリー",
    ...
    "image": "assets/img/lib/P0033-hero.jpg",
    "alt": "世界一長いベンチ／増穂浦海岸",
    "images": [
      {
        "image": "assets/img/lib/P0033-hero.jpg",
  ...
  "photos": [
    ...
    },
    {
      ...
      "image": "assets/img/lib/P0004-new.jpg",
      "alt": "日本海に切り立つヤセの断崖"
    },
    {
      "id": "P0005",
  ...
  "footer": {
    "primary": [
      {
        "label": "志賀町観光情報",
        "href": "https://shika-guide.jp",
        "icon": "i-compass"
      },
      {
        "label": "Instagram",
        "href": "https://www.instagram.com/shikatown_official/",
        "icon": "i-instagram"
      },
      {
        "label": "お問い合わせ",
