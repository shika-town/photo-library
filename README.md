...
スプレッドシートを直接編集するのが不安な場合は、`docs/02_管理者向け/管理画面_設置手順.md` の管理画面を入れてください。
写真登録・承認・写真の表示ON/OFF・キャプション変更・スポット説明の修正を、専用画面から行えます。

担当者への共有には `docs/01_担当者向け/担当者マニュアル_フォトライブラリー管理画面.md`、管理者の保守には
`docs/02_管理者向け/管理者マニュアル_フォトライブラリー運用保守.md` を使ってください。
